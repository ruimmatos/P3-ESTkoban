...
public class DetectorColisoes {
	 ...
	 * Cada linha representada pela sua equacao linear. Linha 1 = a*x + c, Linha 2 = b*x + d
	 * @param a declive da linha 1
	 * @param c origem da linha 1
	 * @param b declive da linha 2
	 * @param d origem da linha 2
	 * @return ponto de interseccao
	 */
	...
	/** Retorna o ponto de intersecao entre duas linhas.
	 * Cada linha esta representada por dois pontos
	 * 
